      ...
      <div className="container">
        <div className="flex justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
          ...
          <div className="relative w-3/4 lg:w-1/2 xl:w-[770px] z-10 order-2 lg:order-1">
            <img
              src={
                "https://hips.hearstapps.com/hmg-prod/images/shutterstock-334999139-main-billion-photos-1486055063.jpg"
              }
              alt=""
              className="max-w-[450px] object-cover rounded-xl"
            />
          ...
          <div className="w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
            ...
            <p className="text_para mt-[30px]">
              ...
              we can do tommorow. Providint the best. Lorem ipsum dolor sit
